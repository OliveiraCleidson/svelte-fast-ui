...
<div class="flex flex-col gap-6">
	<div class="flex items-center gap-3">
		...
		<Label for="ex-terms">Accept terms and conditions</Label>
	</div>
	<div class="flex items-start gap-3">
		<Checkbox id="ex-terms-2" checked />
		<div class="grid gap-2">
			<Label for="ex-terms-2">Accept terms and conditions</Label>
	...
	<div class="flex items-start gap-3">
		<Checkbox id="ex-toggle" disabled />
		<Label for="ex-toggle">Enable notifications</Label>
	</div>
	<Label
