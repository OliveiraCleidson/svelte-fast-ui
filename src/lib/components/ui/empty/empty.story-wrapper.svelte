<script lang="ts">
	...
	import * as Kbd from '../kbd/index.js';
	...
	let {
		...
		variant?: 'default' | 'outline' | 'background' | 'avatar' | 'avatar-group' | 'input-group';
	} = $props();
</script>
